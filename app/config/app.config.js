...
export const uploadDir = "/assets/uploads";
export const otpTimeout = 120; //in seconds
export const passwordResetOtpAttepts = 5;
export const supportedImageSizes = 5; // 5MB
export const supportedImageTypes =
  /jpeg|jpg|png|webp|svg|ico|css|vnd\.openxmlformats\-officedocument\.wordprocessingml\.document/;
export const supportedFileSizes = 10; // 10MB
